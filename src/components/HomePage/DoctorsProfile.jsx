  ...
  const doctors = [
    {
      ...
      image: "/images/dr-rajkumar.png",
      qualifications: ["M.B.B.S.", "M.S.", "D.N.B. (Urology)"],
      specialization: "Urology & Andrology",
      experience: "20+ Years",
      surgeries: "25000+",
      description: "Dr. Rajkumar Khasgiwala S/o Late Sh. P.M. Khasgiwala is the Managing Director of Paras Urology and Multispeciality Hospital. He completed his M.B.B.S., M.S. from J.L.N. Medical College and earned his D.N.B. (Urology) from Sir H.N. Hospital, Mumbai in 2004.",
      expertise: [
    ...
    },
    {
      ...
      image: "/images/dr-minal.jpg",
      qualifications: ["M.B.B.S.", "M.D.", "Diploma Critical Care"],
      specialization: "Anesthesiology & Critical Care",
      experience: "20+ Years",
      surgeries: "Expert Intensivist",
      description: "Dr. Minal Khasgiwala graduated from R.N.T. Medical College, Udaipur in 1997 and completed her post graduation in Anesthesiology from JLN Medical College, Ajmer in 2000. She has extensive experience in treating critically ill patients.",
      expertise: [
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="bg-white/20 backdrop-blur-md rounded-lg p-3 text-center">
                        ...
                        <p className="text-sm">{doctor.id === 1 ? 'Surgeries' : 'Expertise'}</p>
                      </div>
                    </div>
                  </div>
                </div>
